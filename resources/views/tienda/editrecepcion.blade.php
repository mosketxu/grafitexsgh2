<div class="">
    ...
    <div class="mx-2">
            @livewire('elementos.elemento-faltantes',['campaigntienda'=>$campaigntienda,'campaignid'=>$campaign->id,'storeid'=>$store->id,key($campaigntienda->id)])
        <div class="">
