<div class="">
    ...
    <div class="pb-0 mx-2 space-y-1 border rounded-md">
        ...
        {{-- titulos --}}
        <div class="flex">
            <div class="flex {{ $ancho1 }} pt-2 pb-0 pl-2 space-x-1 text-sm font-bold tracking-tighter text-black bg-blue-100 rounded-tl-md">
            ...
            <div class="{{ $ancho2 }}  pt-2 pb-0 pl-2 space-x-1 text-sm font-bold tracking-tighter text-black bg-blue-100 rounded-tr-md">
            </div>
        </div>
        @foreach ($campaigns as $campaign)
        <div class="flex">
            <div onclick="location.href = '{{ route('campaign.edit', $campaign->id) }}'"
                class="flex {{ $ancho1 }} py-0 pl-2 mt-2 space-x-1 text-sm tracking-tighter text-gray-500 border-b border-1 items-center cursor-pointer hover:bg-gray-200">
                ...
                <div class="w-2/12 text-center">{{$campaign->state['1']}}</div>
            </div>
            <div class="{{ $ancho2 }}  ">
