            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card collapsed-card">
                        <div class="p-0 text-white card-header bg-info" data-card-widget="collapse"
                            style="cursor: pointer">
                            <h3 class="pl-3 card-title">Detallado</h3>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="card collapsed-card ">
                                <div class="p-0 text-white card-header bg-indigo" data-card-widget="collapse"
                                    style="cursor: pointer">
                                    <h3 class="pl-3 card-title">Tiendas por zonas</h3>
                                    <div class="pr-3 card-tools">
                                        <button type="button" class="btn btn-tool"><i class="fas fa-plus"></i></button>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            {{-- materiales --}}
                            <div class="card collapsed-card">
                                <div class="p-0 text-white card-header bg-navy" data-card-widget="collapse"
                                    style="cursor: pointer">
                                    <h3 class="pl-3 card-title">Por materiales</h3>
                                    <div class="pr-3 card-tools">
                                        <button type="button" class="btn btn-tool"><i class="fas fa-plus"></i></button>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            {{-- segmentos --}}
                            <div class="card collapsed-card ">
                                <div class="p-0 text-white card-header bg-purple" data-card-widget="collapse"
                                    style="cursor: pointer">
                                    <h3 class="pl-3 card-title">Por segmentos</h3>
                                    <div class="pr-3 card-tools">
                                        <button type="button" class="btn btn-tool"><i class="fas fa-plus"></i></button>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            {{-- store concepts --}}
                            <div class="card collapsed-card">
                                <div class="p-0 text-white card-header bg-fuchsia" data-card-widget="collapse"
                                    style="cursor: pointer">
                                    <h3 class="pl-3 card-title">Por Store Concepts</h3>
                                    <div class="pr-3 card-tools">
                                        <button type="button" class="btn btn-tool"><i class="fas fa-plus"></i></button>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            {{-- mobiliario --}}
                            <div class="card collapsed-card ">
                                <div class="p-0 text-white card-header bg-pink" data-card-widget="collapse"
                                    style="cursor: pointer">
                                    <h3 class="pl-3 card-title">Por Mobiliarios</h3>
                                    <div class="pr-3 card-tools">
                                        <button type="button" class="btn btn-tool"><i class="fas fa-plus"></i></button>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            {{-- propxelemento --}}
                            <div class="card collapsed-card">
                                <div class="p-0 text-white card-header bg-maroon" data-card-widget="collapse"
                                    style="cursor: pointer">
                                    <h3 class="pl-3 card-title">Por Prop x Elemento</h3>
                                    <div class="pr-3 card-tools">
                                        <button type="button" class="btn btn-tool"><i class="fas fa-plus"></i></button>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            {{-- carteleria --}}
                            <div class="card collapsed-card ">
                                <div class="p-0 text-white card-header bg-orange" data-card-widget="collapse"
                                    style="cursor: pointer">
                                    <h3 class="pl-3 card-title">Por Carteleria</h3>
                                    <div class="pr-3 card-tools">
                                        <button type="button" class="btn btn-tool"><i class="fas fa-plus"></i></button>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            {{-- medidas --}}
                            <div class="card collapsed-card">
                                <div class="p-0 text-white card-header bg-lime" data-card-widget="collapse"
                                    style="cursor: pointer">
                                    <h3 class="pl-3 card-title">Por medidas</h3>
                                    <div class="pr-3 card-tools">
                                        <button type="button" class="btn btn-tool"><i class="fas fa-plus"></i></button>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="card collapsed-card">
                                <div class="p-0 text-white card-header bg-teal" data-card-widget="collapse"
                                    style="cursor: pointer">
                                    <h3 class="pl-3 card-title">Por Material y Medida</h3>
                                    <div class="pr-3 card-tools">
                                        <button type="button" class="btn btn-tool"><i class="fas fa-plus"></i></button>
                                    </div>
                                </div>
                        ...
                        <div class="col">
                            ...
                            <div class="card collapsed-card">
                                <div class="p-0 text-white card-header bg-olive" data-card-widget="collapse"
                                    style="cursor: pointer">
                                    <h3 class="pl-3 card-title">Por Idioma Material Medida Mobiliario</h3>
                                    <div class="pr-3 card-tools">
                                        <button type="button" class="btn btn-tool"><i class="fas fa-plus"></i></button>
                                    </div>
                                </div>
