<x-app-layout>
    ...
    <div class="p-2">
        ...
        <div class="flex justify-between m-2">
            <div class="">
                <x-button type="button" class="py-2 text-gray-800 border-gray-200 bg-gray-50" onclick="location.href = '{{ route('campaign.presupuesto.cotizacion',$presupuesto) }}'" color="gray" >{{ __('Volver') }}</x-button>
            </div>
