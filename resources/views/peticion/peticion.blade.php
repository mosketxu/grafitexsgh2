<form wire:submit.prevent="save" class="">
    <div class="flex p-2 space-x-2">
        <div class="w-1/12 form-item">
            ...
            class="w-full py-1 text-sm bg-blue-100 border-blue-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
            disabled/>
        ...
        <div class="w-2/12 form-item">
            ...
            <input type="text"
            value="{{ $solicitadopor }}"
            class="w-full py-1 text-sm text-gray-600 bg-blue-100 border-blue-300 rounded-md shadow-sm appearance-none hover:border-blue-400 focus:outline-none"
            disabled/>
    ...
    <div class="flex w-full p-2 ">
        <div class="w-full form-item">
            ...
            class="w-full py-1 text-sm border-blue-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" {{ $deshabilitado }}></textarea>
