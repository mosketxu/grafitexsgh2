...
<select name= {{$selectname}}
    ...
    {{$attributes->merge(['class'=>"text-xs py-1 border-$color-300 rounded-md shadow-sm text-gray-600 focus:border-$color-300 focus:ring focus:ring-$color-200 focus:ring-opacity-50"]) }}>
    {{ $slot }}
</select>
