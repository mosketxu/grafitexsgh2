<div class="w-full border rounded-md shadow-md">
    <div class="flex justify-between w-full py-1 text-white bg-pink-800 rounded-t-md" style="cursor: pointer" wire:click="$toggle('visible')" >
    ...
    <div class="">
        ...
        <div class="">
            ...
            @foreach($mobiliarios as $detalle)
                <div class="flex w-full">
                    <div class="w-6/12 pl-2">{{$detalle->mobiliario}}</div>
