<div class="w-full border rounded-md shadow-md">
    <div class="flex justify-between w-full py-1 text-white bg-teal-400 rounded-t-md" style="cursor: pointer" wire:click="$toggle('visible')" >
    ...
    <div class="">
        {{-- <div class="pl-2">
            {{ $tiendaszonas->appends(request()->except('page'))->links() }}
        </div> --}}
        <div class="">
            <div class="flex w-full text-white bg-black">
                <div class="w-3/12 pl-2">Country</div>
            ...
            @foreach($tiendaszonas as $detalle)
                <div class="flex w-full">
                    <div class="w-3/12 pl-2">{{$detalle->country}}</div>
                    <div class="w-3/12">{{$detalle->area}}</div>
