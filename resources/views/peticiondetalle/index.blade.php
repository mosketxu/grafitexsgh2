        ...
        <div class="py-1 space-y-4">
            <div class="flex-col space-y-1">
                ...
                <div class="flex w-full py-2 pl-2 space-x-2 text-sm text-gray-500 bg-green-100 rounded-t-md">
                    <div class="w-4/12 font-light md:w-4/12" ><input type="text" class="w-full py-0 text-sm text-gray-500 bg-green-100 border-0 rounded-md" value= "{{ __('Producto') }}" /></div>
                ...
                <div>
                    @forelse ($detalles as $detalle)
                        <div class="flex w-full items-center py-0.5 pl-2 space-x-2 text-sm border-t-0 border-y" wire:loading.class.delay="opacity-50">
                            <div class="w-4/12 md:w-4/12">
                                <input type="text" class="w-full py-0.5 text-sm font-thin text-gray-500 border-0 rounded-md" value="{{ $detalle->producto->producto }}" readonly/>
                            </div>
                            <div class="w-4/12 md:w-4/12">
                                <input type="text" class="w-full py-0.5 text-sm font-thin text-gray-500 border-0 rounded-md" value="{{ $detalle->comentario }}" readonly/>
                            </div>
                            <div class="w-1/12 md:flex md:w-1/12">
                                <input type="text" class="w-full py-0.5 text-sm font-thin text-gray-500 border-0 rounded-md" value="{{ $detalle->unidades }}" readonly/>
                            </div>
                            <div class="w-1/12 md:w-1/12">
                                <input type="text" class="w-full py-0.5 text-sm font-thin text-gray-500 border-0 rounded-md" value="{{ $detalle->preciounidad }}" readonly/>
                            </div>
                            <div class="w-1/12 md:flex md:w-1/12">
                                <input type="text" class="w-full py-0.5 text-sm font-thin text-gray-500 border-0 rounded-md" value="{{ $detalle->total }}"  readonly/>
                            </div>
                            {{-- <div class="w-2/12 ">
