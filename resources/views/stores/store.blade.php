            ...
            <div class="flex-col space-y-1 text-gray-500 border border-blue-300 rounded shadow-md">
                ...
                <div class="p-1 m-1 space-y-1">
                    ...
                    <div class="">
                        ...
                        @endcan
                        <x-button.button  class="py-2" onclick="location.href = '{{ route('store.addresses') }}'" color="green" >{{ __('Volver a direcciones') }}</x-button.button>
                        <x-button.button  class="py-2 text-black" onclick="location.href = '{{ route('store.index') }}'" color="gray" >{{ __('Volver a stores') }}</x-button.button>
                    </div>
                </form>
            </div>
        </div>
