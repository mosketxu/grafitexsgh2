...
class PeticionHistorial extends Model
{
    ...
    protected $fillable=['peticion_id','user_id','estadopeticion_id','observaciones'];
    ...
    public function estadohistorial(){return $this->belongsTo(EstadoPeticion::class, 'estadopeticion_id','id');}
