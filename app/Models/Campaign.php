...
class Campaign extends Model
{
    ...
    protected $fillable=['campaign_name','campaign_initdate','campaign_enddate','campaign_state','slug','fechainstal1','fechainstal2','fechainstal3','montaje1','montaje2','montaje3'];
