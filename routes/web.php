...
use App\Http\Controllers\{CampaignController, ElementoController, MaestroController, RoleController, StoreController, TarifaController, UserController};
...
Route::group(['prefix' => 'campaign'], function () {
    ...
    //store.php
    Route::get('store/adresses','StoreController@adresses')->name('store.adresses')->middleware('can:store.index');
    Route::post('store/updatetiendas','StoredataController@import')->name('store.updatetiendas')->middleware('can:store.edit');
    Route::post('store/updateimagenindex', 'StoreController@updateimagenindex')->name('store.updateimagenindex')->middleware('can:store.create');
